...
a_vals = [0, se.nan, se.nan, 0, 0, se.nan, se.nan, 0, 0, 0]
for i in range(N):
    if a_vals[i] == se.nan:
        pass
    else:
...
alpha_vals = [se.S(se.pi)/2, 0, 0, se.S(se.pi)/2, se.S(se.pi)/2, 0, 0, se.S(se.pi)/2, -se.S(se.pi)/2, 0]
for i in range(N):
...
d_vals = [se.nan, 0, 0, se.nan, se.nan, 0, 0, se.nan, se.nan, se.nan]
for i in range(N):
